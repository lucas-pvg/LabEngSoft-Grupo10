...
class VooForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'partidaPrevista': forms.DateTimeInput(attrs={'class': 'form-control', 'placeholder': 'Mês/Dia/Ano'}),
            'chegadaPrevista': forms.DateTimeInput(attrs={'class': 'form-control', 'placeholder': 'Mês/Dia/Ano'}),
